        ...
        Patterns(MemoryBist_P1_repair_r2) {
            tester_period : 80ns;
            ClockPeriods {
                PCIE_REF_CLK_P : 10ns;
                SYNC_CLK : 8ns;
        ...
        Patterns(MemoryBist_P1_repair_r3) {
            tester_period : 80ns;
            ClockPeriods {
                PCIE_REF_CLK_P : 10ns;
                SYNC_CLK : 8ns;
        ...
        Patterns(MemoryBist_P1_repair_r2_etcam_u2) {
            tester_period : 80ns;
            ClockPeriods {
                PCIE_REF_CLK_P : 10ns;
                SYNC_CLK : 8ns;
            ...
            TestStep(Mbist_P1_repair_r2_etcam_u2) {
                MemoryBist {
                run_mode : run_time_prog;
                reduced_address_count : off;
        ...
        Patterns(MemoryBist_P1_repair_r2_odma) {
            tester_period : 80ns;
            ClockPeriods {
                PCIE_REF_CLK_P : 10ns;
                SYNC_CLK : 8ns;
            ...
            TestStep(Mbist_P1_repair_r2_odma) {
                MemoryBist {
                run_mode : run_time_prog;
                reduced_address_count : off;
        ...
        Patterns(MemoryBist_P1_repair_r3_smmu0) {
            tester_period : 80ns;
            ClockPeriods {
                PCIE_REF_CLK_P : 10ns;
                SYNC_CLK : 8ns;
            ...
            TestStep(Mbist_P1_repair_r3_smmu0) {
                MemoryBist {
                run_mode : run_time_prog;
                reduced_address_count : off;
